...
const Home: NextPage = () => {
  return (
    <div className="min-safe-h-screen scroll-smooth overflow-x-hidden bg-myBlack text-white font-amiri scrollbar-track-myBlack/80 scrollbar-white/90 scrollbar-thin root">
      <Head>
