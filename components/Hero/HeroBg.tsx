export default function HeroBg() {
  return (
    <>
      ...
      <div className="absolute right-20 top-24 lg:right-11 lg:top-40 opacity-10 w-96 text-xs sm:text-sm">
        <q>
      ...
      <div className="absolute right-4 top-40 lg:right-40 lg:top-[45%] opacity-10 text-xs sm:text-sm w-40">
        <q>
      ...
      <div className="absolute hidden lg:block left-72 bottom-36 opacity-10 text-xs sm:text-sm w-44">
        <q>
