...
const Hero = () => {
  ...
  return (
    <m.div
      ...
      initial="hidden"
      animate="visible"
      className="h-full md:h-screen flex items-center justify-center text-6xl relative z-10 mx-auto py-56 md:py-20"
    >
      <m.div
        variants={item}
      ...
      <div className="absolute bottom-6 sm:-bottom-16 md:bottom-4 left-[50%] -translate-x-1/2 flex justify-center ">
        <m.div
          variants={item}
